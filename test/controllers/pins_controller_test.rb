...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { board: @pin.board, description: @pin.description, pin_image: @pin.pin_image, title: @pin.title, url: @pin.url }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { board: @pin.board, description: @pin.description, pin_image: @pin.pin_image, title: @pin.title, url: @pin.url }
    assert_redirected_to pin_path(assigns(:pin))
  end
